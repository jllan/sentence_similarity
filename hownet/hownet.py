...
def similar_sentence(sent1, sent2):
    similar_sent = 0.0
    for w1 in sent1:
        similar_word_max = 0.0
        for w2 in sent2:
            score = similar_word(w1, w2)
            # print('{}, {}, {}'.format(w1, w2, score))
            similar_word_max = max(similar_word_max, score)
        similar_sent += similar_word_max
    return similar_sent/len(sent1)
...
#   print('=====================')
   print(similar_sentence('孩子们'.split(), '孩子'.split()))  # 0.6
